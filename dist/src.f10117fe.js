...
function () {
  ...
  DefaultPiece.prototype.move = function (from, to) {
    if (!this.canMove(to.position)) {
      throw new Error("unable to move there!");
    }
...
function (_super) {
  ...
  Lion.prototype.render = function () {
    if (this.ownerType == "upper") {
      return "<img class=\"piece " + this.ownerType + "\" src=\"" + lion_png_1.default + "\" width=\"90%\" height=\"90%\" style=\"transform: scaley(-1)\"/>";
    } else {
...
function (_super) {
  ...
  Elephant.prototype.render = function () {
    if (this.ownerType == "upper") {
      return "<img class=\"piece " + this.ownerType + "\" src=\"" + elophant_png_1.default + "\" width=\"90%\" height=\"90%\" style=\"transform: scaley(-1)\"/>";
    } else {
...
function (_super) {
  ...
  Griff.prototype.render = function () {
    if (this.ownerType == "upper") {
      return "<img class=\"piece " + this.ownerType + "\" src=\"" + griff_png_1.default + "\" width=\"90%\" height=\"90%\" style=\"transform: scaley(-1)\"/>";
    } else {
...
function (_super) {
  ...
  Chick.prototype.render = function () {
    if (this.ownerType == "upper") {
      return "<img class=\"piece " + this.ownerType + "\" src=\"" + chicken_png_1.default + "\" width=\"90%\" height=\"90%\" style=\"transform: scaley(-1)\"/>";
    } else {
...
new Game_1.Game();
},{"./Game":"src/Game.ts","bootstrap/dist/css/bootstrap":"../../node_modules/bootstrap/dist/css/bootstrap.css","../styles/style.css":"styles/style.css"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
