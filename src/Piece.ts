...
export class Lion extends DefaultPiece {
    ...
    render(): string {
        if (this.ownerType == "upper") {
            return `<img class="piece ${this.ownerType}" src="${lionImage}" width="90%" height="90%" style="transform: scaley(-1)"/>`;
        } else {
...
export class Elephant extends DefaultPiece {
    ...
    render(): string {
        if (this.ownerType == "upper") {
            return `<img class="piece ${this.ownerType}" src="${elophantImage}" width="90%" height="90%" style="transform: scaley(-1)"/>`;
        } else {
...
export class Griff extends DefaultPiece {
    ...
    render(): string {
        if (this.ownerType == "upper") {
            return `<img class="piece ${this.ownerType}" src="${griffImage}" width="90%" height="90%" style="transform: scaley(-1)"/>`;
        } else {
...
export class Chick extends DefaultPiece {
    ...
    render(): string {
        if (this.ownerType == "upper") {
            return `<img class="piece ${this.ownerType}" src="${chickenImage}" width="90%" height="90%" style="transform: scaley(-1)"/>`;
        } else {
